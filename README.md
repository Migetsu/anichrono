...
Для локального тестирования используйте редирект `http://localhost:5173/auth/callback` и установите `SHIKI_REDIRECT_URI` на этот адрес. Запросы к `/auth/*` автоматически перенаправляются на соответствующие серверные функции.
