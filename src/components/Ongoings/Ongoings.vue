...
const QUERY_ONGOINGS = `
  query ($limit: Int, $page: Int, $status: AnimeStatusString) {
    animes(status: $status, order: popularity, limit: $limit, page: $page) {
      id
      name
      russian
      score
...
const loadAnimes = async () => {
  ...
  try {
    const data = await shikiGQL(QUERY_ONGOINGS, { limit: LIMIT, status: 'ongoing', page: page.value })
